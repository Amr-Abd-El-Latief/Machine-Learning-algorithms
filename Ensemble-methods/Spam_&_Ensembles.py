...
BaggingCF = BaggingClassifier(n_estimators=200)

# Instantiate a RandomForestClassifier with:
# 200 weak learners (n_estimators) and everything else as default values
randomForestCF= RandomForestClassifier(n_estimators = 200)
...
AdaBoostCF= AdaBoostClassifier(n_estimators = 300,learning_rate = 0.2 )
...
BaggingCF = BaggingCF.fit(training_data,y_train)

# Fit your RandomForestClassifier to the training data
randomForestCF = randomForestCF.fit(training_data,y_train)

# Fit your AdaBoostClassifier to the training data
AdaBoostCF = AdaBoostCF.fit(training_data,y_train)
...
Y_pred_Bagging = BaggingCF.predict(testing_data)
# Predict using RandomForestClassifier on the test data
Y_pred_RandomForest = randomForestCF.predict(testing_data)

# Predict using AdaBoostClassifier on the test data

Y_pred_AdaBoost = AdaBoostCF.predict(testing_data)
...
print(print_metrics(y_test, Y_pred_Bagging, model_name='Bagging'))

# Print Random Forest scores
print(print_metrics(y_test, Y_pred_RandomForest, model_name='Random Forest'))


# Print AdaBoost scores
print(print_metrics(y_test, Y_pred_AdaBoost, model_name='AdaBoost'))


# Naive Bayes Classifier scores

print(print_metrics(y_test, predictions, model_name='Naive Bayes'))
